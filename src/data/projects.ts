// Canonical project seed data — synced byte-identically with the prototype's
...
// Backwards-compat alias for the old TechItem name.
    ...
    techStack: [
      {
        name: "Next.js",
        reason:
          "Server components for secure API key handling and fast initial page load. App Router gave clean separation between scheduling UI and API routes.",
      },
      {
        name: "FastAPI",
        reason:
          "Python backend for the Monte Carlo simulation engine. Async support handles concurrent simulation requests without blocking.",
      },
      {
        name: "Gemini 2.5 Flash",
        reason:
          "Chosen over GPT-4 for cost efficiency and speed. Flash model handles natural language schedule parsing at sub-second latency.",
      },
      {
        name: "TypeScript",
        reason:
      ...
      },
      {
        name: "Tailwind CSS",
        reason:
          "Rapid UI iteration for the scheduling dashboard components.",
      },
    ],
    ...
    techStack: [
      {
        name: "Next.js",
        reason:
          "Real-time dashboard needed fast client-side updates while maintaining SSR for initial ERCOT pricing data load.",
      },
      {
        name: "Groq",
        reason:
          "Chose Groq over OpenAI for sub-200ms inference latency. Coordinating 4,200 batteries needs fast dispatch.",
      },
      {
        name: "JavaScript",
        reason:
          "Hackathon speed: JS let us iterate faster than TypeScript for a 24-hour build.",
      },
      {
        name: "Python",
        reason:
    ...
    techStack: [
      {
        name: "Solana",
        reason:
          "Sub-second finality and near-zero fees make it viable for micro-stakes prediction markets. Ethereum L1 fees would kill the UX.",
      },
      {
        name: "TypeScript",
        reason:
          "Anchor framework for Solana programs uses TypeScript for the client SDK. Consistent typing across frontend and blockchain.",
      },
      {
        name: "Next.js",
        reason:
          "Prediction market UI needed real-time updates with SSR for SEO on market listing pages.",
      },
      {
        name: "Python",
        reason:
          "ML model for flight delay probability trained on historical FAA data. scikit-learn served via a lightweight API.",
      },
    ],
  ...
  },
  {
    ...
    techStack: [
      ...
      },
      {
        name: "ethers.js",
        reason:
          "Lightweight Ethereum library. Chose over web3.js for smaller bundle size and cleaner TypeScript types.",
      },
      {
        name: "Ethereum Sepolia",
        reason:
          "Testnet deployment for safe iteration. Reliable faucets and fast block times for dev.",
      },
    ],
    ...
    techStack: [
      {
        name: "React Native",
        reason:
          "Cross-platform mobile from one codebase. Critical for the full UT student body regardless of device.",
      },
      {
        name: "Firebase",
        reason:
          "Real-time DB for instant profile exchanges when BLE proximity is detected. Firestore listeners made nearby-people feel instant.",
      },
      {
        name: "Bluetooth Low Energy",
        reason:
          "BLE beacons for proximity without internet. Works in crowded venues where WiFi is congested.",
      },
      {
        name: "TypeScript",
        reason:
    ...
    techStack: [
      {
        name: "Next.js 15",
        reason:
          "Server actions for the commission calculation engine. Improved caching made the financial dashboards snappy.",
      },
      {
        name: "TypeScript",
        reason:
          "Financial calculations demand type safety. A number/string confusion in commission math could cascade.",
      },
      {
        name: "Tailwind CSS",
        reason:
          "Rapid prototyping for the dense dashboard UI. 24 hours meant zero time for custom CSS.",
      },
    ],
  ...
  },
  {
    ...
    techStack: [
      ...
      },
      {
        name: "React Native",
        reason:
          "Android deployment with the option to expand to iOS. Audio libraries handled playback controls cleanly.",
      },
    ],
